...
void studentPanel()
{
    ...
    while(1)
	{
        ...
        if(isValid(userID)!=1)
        {
            printf("\n  Incorrect User Credentials --> Press Enter");
            getch();
            continue;
        }
